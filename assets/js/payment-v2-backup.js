...
function getTransactionData(){
    ...
    .done(function(data) {
        if (data.payment_method == 'Paymaya') {
            checkPaymayaPaymentStatusCard(data.payment_reference_no, data.auth.api, data.attributes);
        }
            ...
            string+='<div class="margin-bottom-40 transactionForm">'
                +'<div class=" margin-top-10">'
                  +'<div class="margin-bottom-20">'
                    +'<h3 class="font-400 margin-top-20 text-left text-uppercase" style="color: #3a3a3a !important; font-family: Poppins !important; font-size: 18px;"><i class="fa fa-info-circle"></i> Order Summary:</h3>'
...
function transactionStatus(data){
    ...
    if (data.status == '1') {
        ...
        paid_credit+='<div class="row margin-top-10" id="game_credit_wrapper">'
                      ...
                      +'</div>'
                    +'</div>';
        parag += "<div>We hope you're happy with your purchase. We'd love to hear how satisfied you are with your order. Please don't forget to <a href='https://xquareshop.com/reviews?utm_source=kenkarlo_success_payment_page&utm_medium=make_another_purchase_button&utm_campaign=reorder' target='_blank' rel='noopener'>give us review</a>. Thank you! :).</div>"
        +"<div class='margin-top-10'>For inquiries, you may contact us on xquare@kenkarlo.com or message our <a href='https://facebook.com/xquareshop' rel='noopener nofollow' blank='_blank'>FB Page</a>.</div>"
        +"<div class='text-left margin-top-20'>"
          +"<a class='btn btn-secondary' href='"+btn_make_purchase+"'>Make another purchase</a>"
        +"</div>";
        ...
        parag = "<div>Thank you for your order, we will validate your transaction first, <b>make sure you input the correct "+data.payment_method+" ref.no./transaction code</b>. </div>"
            +"<div class='margin-top-10'>For inquiries, you may contact us on xquare@kenkarlo.com or on our <a target='_blank' rel='noopener nofollow' href='https://facebook.com/xquareshop' rel='noopener nofollow' blank='_blank'>FB Page</a> Thank you!</div>"
       ...
       +receipt
        ...
        +'<div class=" margin-top-10">'
            ...
            +'<div class="margin-bottom-20 text-center">'
                +'<img src="'+img_status+'" draggable="false" class="img-fluid" width="90" height="90">'
